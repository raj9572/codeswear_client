    ...
    <>
        <div className='grid md:grid-cols-12 gap-4  md:px-10 py-4 ' >
             ...
             <div className='md:col-span-2   border-2 border-black md:min-h-[400px] flex md:flex-col  flex-row gap-2'>
                ...
                <button onClick={()=>{navigate("/admin/orderlist")}} className=' md:text-2xl font-base font-medium text-white hover:bg-pink-600 bg-pink-500 md:w-full w-1/4 md:h-28'>All Orders</button>
             </div>
