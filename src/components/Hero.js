...
const Hero = () => {
  return (
    <div className='mb-5 border-2 border-black w-full md:h-[64vh] h-[80vh]  relative bg-slate-400'>
        ...
        <div className='absolute w-full h-full left-0 top-0 transition duration-700 ease-in-out hover:bg-black hover:opacity-30'></div>
         <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center'>
             ...
             <button className='bg-rose-500 py-1 px-3 rounded-md font-medium text-base text-white hover:bg-rose-600'>explore more</button>
         </div>
    </div>
  )
}
